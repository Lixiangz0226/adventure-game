...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        try {
            tile[0] = new Tile();
            tile[0].image = ImageIO.read(getClass().getResourceAsStream("/Resoures/Forest_barrier.png.png"));
            tile[0].collision = true;

            tile[1] = new Tile();
            tile[1].image = ImageIO.read(getClass().getResourceAsStream("/Resoures/Forest_ground.png.png"));
